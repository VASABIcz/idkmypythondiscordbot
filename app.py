...
async def que(ctx, nam):
    ...
    try:
        embed.add_field(name=qee[0 + n], value=str(1 + n), inline=False)
    except:
        pass
    try:
        embed.add_field(name=qee[1 + n], value=str(2 + n), inline=False)
    except:
        pass
    try:
        embed.add_field(name=qee[2 + n], value=str(3 + n), inline=False)
    except:
        pass
    try:
        embed.add_field(name=qee[3 + n], value=str(4 + n), inline=False)
    except:
        pass
    try:
        embed.add_field(name=qee[4 + n], value=str(5 + n), inline=False)
    except:
        pass
